...
export default function ProjectPage() {
  ...
  return (
    <section className="project-detail">
      ...
      {/* ==========================================
          GOAL
          Shows "Goal", NOT "projectPage.projectGoal"
      ========================================== */}
...
{project.type && (
  ...
  <div className="project-section">
    ...
    <p>
      {project.type === "Group"
        ? t("projectPage.groupProject", {
            defaultValue: "Group Project",
          })
        : project.type}
    </p>
      ...
      {hasTranslation(`${projectKey}.targetAudience`) && (
        ...
        <div className="project-section">
          ...
          <h2>
            {t("projectPage.targetAudience", {
              defaultValue: "Target Audience",
            })}
          </h2>

          <p>
            {t(`${projectKey}.targetAudience`)}
          </p>
      ...
      {Array.isArray(t(`${projectKey}.process`, {
        returnObjects: true,
        defaultValue: [],
      })) &&
        getArray(`${projectKey}.process`).length > 0 && (
          ...
          <div className="project-section">
            ...
            <ul className="project-list">
              ...
              {getArray(`${projectKey}.process`).map(
                (item, index) => (
      ...
      {getArray(`${projectKey}.methods`).length > 0 && (
        ...
        <div className="project-section">
          ...
          <ul className="project-list">
            ...
            {getArray(`${projectKey}.methods`).map(
              (item, index) => (
      ...
      {hasTranslation(`${projectKey}.keyLearnings`) && (
        ...
        <div className="project-section">
          ...
          <h2>
            {t("projectPage.keyLearnings", {
              defaultValue: "Key Learnings",
            })}
          </h2>

          <p>
            {t(`${projectKey}.keyLearnings`)}
          </p>
      ...
      {/* ==========================================
          DETAILED PROCESS FROM projectsData.js
